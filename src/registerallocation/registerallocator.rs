...
use crate::livenessanalysis::analyze_liveness;
use crate::registerallocation::interferencegraph::build_interference_graph;
...
pub fn allocate_registers(instructions: &Vec<TacInstruction>) -> HashMap<String, isize> {
    let liveness = analyze_liveness(instructions);
    let interference_graph = build_interference_graph(instructions, &liveness);
