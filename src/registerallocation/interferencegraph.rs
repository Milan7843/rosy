...
pub fn build_interference_graph(instructions: &Vec<TacInstruction>, liveness: &Vec<HashSet<String>>) -> InterferenceGraph {
    return build_interference_graph_naive(instructions, liveness);
...
fn build_interference_graph_naive(instructions: &Vec<TacInstruction>, liveness: &Vec<HashSet<String>>) -> InterferenceGraph {
    let mut graph = InterferenceGraph {
        adjacency_list: std::collections::HashMap::new(),
    };
